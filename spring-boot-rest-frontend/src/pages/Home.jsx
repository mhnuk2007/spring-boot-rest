...
function About() {
  return (
    <div className="container pt-4 d-flex flex-column align-items-start" style={{maxWidth: '900px'}}>
      <div className="bg-white rounded-4 shadow p-4 w-100 mb-4 text-start">
        <div className="d-flex flex-column flex-md-row align-items-center mb-3 gap-3">
          ...
          <h1 className="mb-0 fw-bold" style={{fontSize: '2.2rem'}}>Spring Boot REST Job Portal</h1>
        </div>
        <p className="fs-5 text-secondary mb-3">A full-stack CRUD Job Portal built with <span className="fw-semibold">Java 17, Spring Boot 3, and React</span> as part of the Udemy course <span className="fw-semibold">“Master Java, Spring 6 and Spring Boot 3, Spring JPA, Security, Spring AI, Docker and Microservices”</span> by TELUSKO.</p>
        <div className="row g-4 mb-4">
          ...
          <div className="col-md-6">
            <div className="border rounded-3 p-3 h-100 bg-light">
              <h5 className="fw-bold mb-2">📂 Repo Structure</h5>
              <ul className="mb-0 ps-3">
                <li><strong>spring-boot-rest-backend/</strong>: Spring Boot app (model, controller, service, repository)</li>
        ...
        <div className="mb-4">
          ...
          <ul className="mb-0 ps-3">
            <li>Modern, responsive UI with custom color scheme and fonts</li>
        ...
        <div className="mb-4">
          <h5 className="fw-bold mb-2">🔗 Source Code</h5>
        ...
        <div className="mb-4">
          <h5 className="fw-bold mb-2">🙌 Thanks</h5>
        ...
        <div className="mb-2">
          <h5 className="fw-bold mb-2">📘 Next Up</h5>
          <ul className="mb-0 ps-3">
